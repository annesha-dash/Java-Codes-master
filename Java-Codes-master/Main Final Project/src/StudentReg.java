...
public class StudentReg{
	...
	JPanel thePanel ;
	JLabel firstName, lastName , password, confirmPassword , birthdate ,address ,contactNo , parentsName , parentsNo , email;
	JTextField firstNameField, lastNameField , birthdateField ,contactNoField ,addressField, parentsNameField , parentsNoField,emailField;
			 ...
			 public void actionPerformed(ActionEvent e){
		        	...
		        	if(e.getSource() == reg){
		        		...
		        		if(temp1.equals(temp2) ){
		        				...
		        				StudentClass s1 = new StudentClass(firstNameField.getText(), lastNameField.getText(), birthdateField.getText(), addressField.getText() ,

		        													 contactNoField.getText(), parentsNameField.getText(), parentsNoField.getText() , emailField.getText());

		        				s1.setUserPassword(passFieldTemp);
