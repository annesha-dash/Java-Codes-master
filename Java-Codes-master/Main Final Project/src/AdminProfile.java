...
public class AdminProfile {
	...
	public AdminProfile(JFrame home,AdminClass a1 , UserClass u){
		JFrame layout = new JFrame();
		layout.setSize(800,720);
		layout.setLocationRelativeTo(null);
		layout.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		layout.setTitle( a1.getLastName()+"'s profile");
		thePanel = new JPanel();
		...
		JLabel l2 = new JLabel( a1.getLastName()+", "+a1.getFirstName() );
		...
		JLabel l4 = new JLabel( a1.getBirthDate() );
		...
		JLabel l6 = new JLabel(a1.getAddress());
		...
		JLabel l8 = new JLabel(a1.getContactNo());
		...
		JLabel l10 = new JLabel(a1.getEmail());
